...
const cacheDuration = 60 * 60 * 1000 * 24 * 365; // One year
...
const removeRecord = (params, oldRecords) => {
  return _.omit(oldRecords, params.id);
};
...
export default resource => (previousState = initialState, {payload, meta}) => {
  ...
  switch (meta.fetchResponse) {
    ...
    case CREATE:
      return addRecords([payload.data], previousState);
    case DELETE:
      return removeRecord(payload.data, previousState);
    default:
      return previousState;
  }
};
